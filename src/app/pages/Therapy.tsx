  ...
  return (
    <div className="os-page">
      ...
      {isEmpty ? (
        ...
        <div className="m-stack" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 300px', gap: 20, alignItems: 'start' }}>
          ...
          <div className="therapy-side" style={{ display: 'flex', flexDirection: 'column', gap: 12, position: 'sticky', top: 0 }}>
